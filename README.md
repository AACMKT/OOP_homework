...
Перегрузите магический метод __str__ у всех классов.<br/><br/>
У проверяющих он должен выводить информацию в следующем виде:
<br/>
print(some_reviewer)<br/>
Имя: Some<br/>
Фамилия: Buddy<br/><br/>
У лекторов:<br/>

print(some_lecturer)<br/>
Имя: Some<br/>
Фамилия: Buddy<br/>
Средняя оценка за лекции: 9.9<br/><br/>
А у студентов так:<br/>

print(some_student)<br/>
Имя: Ruoy<br/>
Фамилия: Eman<br/>
Средняя оценка за домашние задания: 9.9<br/>
Курсы в процессе изучения: Python, Git<br/>
Завершенные курсы: Введение в программирование<br/><br/>
